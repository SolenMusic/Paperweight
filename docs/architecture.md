...
circles, surface patterns, surface filters, stylisation processors, and region fields.
...
Paperweight v0.0.13 reads `.pmat` format versions 1 through 10 and writes version 10.
...
rotation, bevel and facet construction, arbitrary instance scattering, and
procedural GPU backends remain outside v0.0.13. MetalKit in v0.0.13 presents
