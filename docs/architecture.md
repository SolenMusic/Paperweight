...
patterns, surface filters, stylisation processors, and region fields.
...
Paperweight v0.0.12 reads `.pmat` format versions 1 through 9 and writes version 9.
...
rotation, masonry-course generation, arbitrary instance scattering, and
procedural GPU backends remain outside v0.0.12. MetalKit in v0.0.12 presents
