...
Paperweight v0.0.16 reads `.pmat` format versions 1 through 13 and writes version 13.
...
rotation, organic branching structures, and procedural GPU backends remain
outside v0.0.16. MetalKit in v0.0.16 presents
