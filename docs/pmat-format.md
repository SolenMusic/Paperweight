...
Paperweight v0.0.32 retains the layer syntax, now at version 23, as the compact,
...
Paperweight v0.0.32 reads versions 1 through 23 and writes version 23. A reader
...
migration to version 23. Version 18 adds opt-in special-surface branches and
