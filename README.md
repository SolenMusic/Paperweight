...
v0.0.13 is the current Masonry and Courses release. One reusable course-layout
generator now builds variable masonry, subdivided slabs, and overlapping roof
slates with stable block and course identities. Courses and blocks may vary in
size, alternate rows can stagger, and restrained crooked boundaries remain
mathematically seamless. The native editor exposes relative and physical metre
controls plus block, mortar, course, and overlap outputs. Four editable castle
showcases demonstrate the shared system. Existing v0.0.12 materials retain
their exact generated bytes.
...
Portable C++20 core
  ...
  structural, course-layout, and surface generators, exact region identity and fields,
...
styles, and castle roof slates. These are the practical forerunners of the
...
Format-version-1 through version-9 `.pmat` files still open with their
historical output intact; saving migrates them to canonical format version 10.
Version 10 adds course layouts and the Course Random region field. Exact block
